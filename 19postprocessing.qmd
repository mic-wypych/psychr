...
We can also make predictions for specific values of our predictors:
...
-   For more complex models (e.g. with interactions) the coefficients will also be misleading and will depend on how you coded the contrasts (dummy, effect etc.). You can make specific comparisons
